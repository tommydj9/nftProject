...
function Dashboard() {
  ...
  return (
    ...
    <div className="page">
      ...
      {isLoading &&
        <div className="absolute bg-white bg-opacity-60 z-10 w-full flex items-center justify-center loading">
      ...
      <nav>
        <ul>
          ...
          <li href="https://tommydj9.github.io/wheel-spin/">Wheel Spin</li>
          <li className="slogBtn" onClick={logout}><a>Logout</a></li>
          {/* <img src="images/wallet.png" id='wallet'></img> */}
      ...
      <div className="content">
        <form onSubmit={onSubmit}>
          ...
          <img src={selected_img} className='mintImg'></img>

          <input
            type="text"
            className="border-[1px] p-2 text-lg border-black w-full mintName"
            value={name}
            placeholder="Name"
            onChange={(e) => setName(e.target.value)}
          />

          <div className="mt-3 mintDescr">
            <input
              type="text"
          ...
          <button
            ...
            type="submit"
            className=" bg-orange-700 text-white text-lg rounded-xl animate-pulse mintBtn"
          >
  ...
  //     {err ? <main class="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
  ...
  //         <h1 className="title2">DeathTune</h1>

  //         <nav class="bg-gray-800 py-1 rounded-md navbar2 nav2">
  //           <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
  //             <div class="relative flex items-center justify-between h-16">
  //               <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
  //                 <button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-red-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
  ...
  //                     <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Wheel Spin</a>
  ...
  //               <ul class="text-gray-600 dark:text-gray-400">
  //                 <li class="mb-4">
  //                   <a href="https://tommydj9.github.io/tipCalcu/" class="hover:underline ">TipCalculator</a>
  //                 </li>
  //                 <li>
